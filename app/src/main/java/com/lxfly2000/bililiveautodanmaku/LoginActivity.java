...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(TestCookies()){
            ...
            findViewById(R.id.buttonLogin).setOnClickListener(view -> DoLogin());
        }
    }
    ...
    private void DoLogin(){
        if(geetestReturned==null){
            Toast.makeText(this,R.string.msg_check_captcha,Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void SubthreadToast(String str){
        runOnUiThread(()->((TextView)findViewById(R.id.textViewStatus)).setText(str));
    }
